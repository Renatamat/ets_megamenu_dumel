...
$(document).ready(function(){
    ...
    $(document).on('change','input[name="product_with_category"]', function () {
        if ($('input#product_with_category_on').is(':checked'))
        {
            $('.row_id_categories').show();
        }
        else
        {
            $('.row_id_categories').hide();
        }
    });
...
function changeProductType()
{
    ...
    if ($('#product_type_specific').is(':checked'))
    {
        ...
        $('.row_product_with_category,.row_id_categories').hide();
    }
    else
    {
        $('.row_id_products').hide();
        $('.row_product_count').show();
        $('.row_product_with_category,.row_id_categories').show();
        if ($('input#product_with_category_on').is(':checked'))
        {
            $('.row_id_categories').show();
        }
...
function checkFormFields()
{
    ...
    {
        $('.mm_form .row_product_type,.mm_form .row_product_count,.mm_form .row_image, .mm_form .row_id_manufacturers, .mm_form .row_id_categories, .mm_form .row_id_cmss,.mm_form .row_image_link,.mm_form .row_content,.mm_form .row_customer_groups,.mm_form .row_display_content_mobile,.mm_form .row_id_products, .mm_form .row_id_suppliers,.mm_form .row_order_by_category,.mm_form .row_order_by_suppliers,.mm_form .row_order_by_manufacturers,.mm_form .row_display_mnu_name, .mm_form .row_display_mnu_inline,.mm_form .row_display_suppliers_name,.mm_form .row_display_suppliers_inline,.mm_form .row_display_suppliers_img,.mm_form .row_display_mnu_img,.mm_form .row_show_description, .mm_form .row_show_clock').hide();
        if($('.mm_form select[name="block_type"]').val()=='HTML'){
            $('.mm_form .row_content').show();
            $('.mm_form .row_customer_groups').show();
            $('.mm_form .row_display_content_mobile').show();
        }
        ...
        {
            $('.mm_form .row_show_description, .mm_form .row_show_clock, .mm_form .row_id_categories,.mm_form .row_id_products').show();
            changeProductType();
        }
